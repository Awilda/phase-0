...
// I initially got stuck with adding adam as terah's spouse. I noticed it said instance of
// Object and I had to look that up. So, going on forward, I new a new object had to be
// created. It worked because now theres was an Object to call from.

// How difficult was it to add and delete properties outside of the object itself?

// It wasn't too bad. I definitely had to think through this one but then there was a 
// natural pattern to it. 

// What did you learn about manipulating objects in this challenge?

// I learned that you can only call from Objects that exists. Also, when using pipes
// to delete, the value on the right with equal to true.
