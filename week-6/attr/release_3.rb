...
# Along with the attribute reader for age, there's an attribute writer for age. The 
# change_my_age(new_age) is also ommitted.

# What was replaced?
# The 'instance_of_profile.change_my_age' now reads 'instance_of_profile.age.' 
