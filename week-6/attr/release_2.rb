...
# There's an attr_reader right after the class name for the age. The what_is_age method is 
# also omitted.

# What was replaced?
# The driver code for the what_is_age method was 'p instance_of_profile.what_is_age' and now 
# it's 'p instance_of_profile.age'

# Is this code simpler than the last?
# This code is more condensed than the last. I believe it is simpler because it requires less
# code and right away after the class you see the attribute reader and know to expect the age
# to be printed as is.