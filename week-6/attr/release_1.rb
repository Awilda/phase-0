...
# The methods are printing out an age, name and occupation as well as a new age, new name and
# new occupation from an input.

# How are they modifying or returning the value of instance variables?
# The instance variable from one method is used in another one where a new input is assigned
# to the instance variable, thus changing its value.